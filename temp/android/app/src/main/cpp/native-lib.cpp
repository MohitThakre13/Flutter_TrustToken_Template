...
Java_com_example_temp_MainActivity_libint(JNIEnv *env, jobject mainActivityInstance,
                                                     jint fileDescriptor) {
...
Java_com_example_temp_MainActivity_login(JNIEnv *env, jobject mainActivityInstance,
                                                    jstring jStr) {
...
JNIEXPORT jstring JNICALL
Java_com_example_temp_MainActivity_readCertificate(JNIEnv *env,
...
JNIEXPORT jstring JNICALL
Java_com_example_temp_MainActivity_logout(JNIEnv *env, jobject thiz) {
    if (getLibraryHandle() == nullptr) {
        return env->NewStringUTF("Failed to load library");
    }
...
JNIEXPORT jstring JNICALL
Java_com_example_temp_MainActivity_signData(JNIEnv *env, jobject mainActivityInstance) {
...
JNIEXPORT jstring JNICALL
Java_com_example_temp_MainActivity_verify(JNIEnv *env, jobject thiz, jstring jsig, jstring data) {
    if (getLibraryHandle() == nullptr) {
        return env->NewStringUTF("Failed to load library");
    }
...
JNIEXPORT jstring JNICALL
Java_com_example_temp_MainActivity_encrypt(JNIEnv *env, jobject mainActivityInstance
) {
...
JNIEXPORT jstring JNICALL
Java_com_example_temp_MainActivity_decrypt(JNIEnv *env, jobject thiz, jstring jStr) {
    if (getLibraryHandle() == nullptr) {
        return env->NewStringUTF("Failed to load library");
    }
